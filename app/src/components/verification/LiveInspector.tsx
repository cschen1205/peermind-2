...
import type { EvidenceLedger } from '@/types/verification'
      ...
      <section>
        ...
        {!inspection.started ? (
          <p className="mt-2 text-[14px] leading-relaxed text-pm-muted">
            This step did not run in the prepared verification.
          </p>
          ...
          <div className="mt-2 grid gap-3">
            ...
            {inspection.verdict ? (
              <div className="flex flex-wrap items-center gap-2">
                <span className="text-[13px] text-pm-muted">Evidence verdict</span>
                <StatusPill status={inspection.verdict} kind="verdict" />
              </div>
            ) : null}
